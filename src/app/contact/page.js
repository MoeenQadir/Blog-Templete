                        ...
                        <div className="-mx-4 flex flex-wrap lg:justify-between">
                            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                                <div className="mb-12 max-w-[570px] lg:mb-0">
                                    <h2 className="text-justify text-dark mb-6 text-[32px] text-center p-5  font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                                        Contact Us
                                    </h2>
